	...
	function windowFunctions:CreateTab(options, ...)
		...
		function tabFunctions:CreateSection(options, ...)
			...
			function sectionFunctions:AddSearchBox(options, ...)
				...
				dropdownSelection.Text = (table.concat(passed_multiselect, ",") and multiselect) or tostring((multiselect and (blankstring or "Select Item(s)")) or (selectedOption and tostring(selectedOption)) or blankstring or "No Blank String")
