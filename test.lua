...
local library = {
	...
	colors = {
		main = Color3.fromRGB(207, 159, 255),
...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateTab(options, ...)
		...
		function tabFunctions:CreateSection(options, ...)
			...
			function sectionFunctions:AddSearchBox(options, ...)
				...
				dropdownSelection.Text = (passed_multiselect == "string" and multiselect) or tostring((multiselect and (blankstring or table.concat(selectedOption,","))) or (selectedOption and tostring(selectedOption)) or blankstring or "No Blank String")
				...
				local Set = (multiselect and function(t, dat)
					...
					local sstr = table.concat(selectedOption,",") or blankstring or "No Blank String"
			...
			function sectionFunctions:AddDropdown(options, ...)
				...
				dropdownSelection.ZIndex = 5
				dropdownSelection.Font = Enum.Font.Code
				dropdownSelection.Text = (passed_multiselect == "string" and multiselect) or (multiselect and tostring(blankstring or table.concat(selectedOption,","))) or (selectedOption and tostring(selectedOption)) or tostring(blankstring or "No Blank String")
				dropdownSelection.TextColor3 = library.colors.otherElementText
				colored[1 + #colored] = {dropdownSelection, "TextColor3", "otherElementText"}
				dropdownSelection.TextSize = 14
				dropdownSelection.TextXAlignment = Enum.TextXAlignment.Left
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		local daaata = {{"AddTextbox", "__Designer.Textbox.ImageAssetID", backgroundsection, {
			Name = "Image Asset ID",
			Placeholder = "rbxassetid://13851358265",
